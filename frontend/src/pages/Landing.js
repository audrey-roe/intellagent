...
import hero from '../assets/images/hero-pattern.png';
import dangote from '../assets/svg/dangote1.6d6f6c9e.svg';
import friesland from '../assets/svg/friesland.b722f03b.svg';
import olam from '../assets/svg/olam.33fdeb36.svg';
import piggyvest from '../assets/svg/piggyvest.921a060a.svg';
        ...
        <div className="bg-white">
            ...
            <main className="-mt-20 sm:mt-0">
                <div className='flex justify-center items-center'>
                    <span className='flex-1 text-center  text-red-600 font-semiboldtraking-wide'> This is not an official Dot website and is only created for DEMO purposes. This application is not to be shared or hosted on any server without express permission from copyright owners.</span>
                </div>
                            ...
                            <div className="mt-20">
                                ...
                                <div className="mt-6 sm:max-w-xl">
                                    <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">
                                        Elevate Your Experience with Dot's Customer Support
                                    </h1>
                                    <p className="mt-6 text-xl text-gray-500">
                                        Our customer support is designed to empower you on your financial journey, ensuring your concerns are addressed promptly and effectively, All you need, on the dot.
                                    </p>
                                </div>
                    ...
                    <div className="sm:mx-auto sm:max-w-3xl sm:px-6">
                        <div
                            ...
                            <div className="hidden sm:block">
                                ...
                                <img
                                    className="absolute top-6 right-1/2 -mr-3 lg:m-0 lg:left-0 "
                                    src={hero} alt="" />
                            </div>
                            <div
                ...
                <div className="relative bg-gray-900">
                    ...
                    <div
                        ...
                        <div className="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
                            ...
                            <p className="mt-3 text-3xl font-extrabold text-white">Connecting the Dots</p>
                            ...
                            <div className="mt-12 grid grid-cols-1 gap-y-12 gap-x-6 sm:grid-cols-2">
                                <p>
                                    <span className="block text-2xl font-bold text-white">55k+</span>
                                    <span className="mt-1 block text-base text-gray-300"><span
                                        className="font-medium text-white">Our agents</span> are spread across Nigeria. From Lagos to Lokoja, we are there.</span>
                                </p>

                                <p>
                                    <span className="block text-2xl font-bold text-white">600k+</span>
                                    <span className="mt-1 block text-base text-gray-300"><span
                                        className="font-medium text-white">600,000+ individuals</span>  have chosen us as their trusted partner.</span>
                                </p>
                                ...
                                <p>
                                    <span className="block text-2xl font-bold text-white">₦31Billion</span>
                                    <span className="mt-1 block text-base text-gray-300"><span
                                        className="font-medium text-white"></span>Total deposits mobilized.</span>
                                </p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <a href="/" className="block mt-2">
                                            <p className="text-xl font-semibold text-gray-900">
                                                Introducing Our Revamped Banking Apps
                                            </p>
                                            <p className="mt-3 text-base text-gray-500">
                                                Blending Innovation with Accessibility
                                                Dot has redefined digital banking by introducing its newly redesigned mobile and web apps. The upgraded platform combines innovation and accessibility to set a new standard in the world of digital finance.
                                            </p>
                                        </a>
                                    </div>
                                ...
                                <div className="flex-1 bg-white p-6 flex flex-col justify-between">
                                    <div className="flex-1">
                                        ...
                                        <a href="/" className="block mt-2">
                                            ...
                                            <p className="mt-3 text-base text-gray-500">
                                                Dot Collaborates with Healthily to Deliver AI-Driven Access to Premium Healthcare
                                            </p>
                                        </a>
                                    </div>
                                    <div className="mt-6 flex items-center">
                ...
                <div className="max-w-7xl mx-auto pt-16 pb-8 px-4 sm:px-6 lg:pt-24 lg:px-8">
                    ...
                    <div
                        ...
                        <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
                            &copy; 2021 Dot. All rights reserved.
                        </p>
                    </div>
                </div>
            </footer>
